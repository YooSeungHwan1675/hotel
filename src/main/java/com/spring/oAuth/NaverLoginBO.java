...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "nJ7VbBziKr0IzaONC5m1";
	private final static String CLIENT_SECRET = "Z6wBs2xF8o";
	private final static String REDIRECT_URI = "http://localhost:8080/project/login/callback";
