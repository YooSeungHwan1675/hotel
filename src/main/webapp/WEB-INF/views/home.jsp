...
<div id="chat">
   <div id="chatArea" style="resize: none; overflow-y: scroll; height: 300px; padding-bottom=10px;"></div>
</div>
...
$(document).ready(function(){
   ...
   // 지울지말지 고민
//     userSock.onopen = function() {
//         sendMessage("사용자가 입장했습니다.");
//     };
    ...
    function appendMessage2(message, isUser) {
        ...
        var messagePosition = isUser ? "right" : "left";
